...
export default function Sidebar({ activeTab, setActiveTab, activeMode, setActiveMode }) {
  const navItems = [
    ...
    <aside style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: "6px" }}>
          ...
          <button
            onClick={() => { setActiveMode("study"); setActiveTab("study"); }}
            style={{
              flex: 1,
              padding: "4px",
              fontSize: "0.7rem",
          ...
          <button
            onClick={() => { setActiveMode("coding"); setActiveTab("coding"); }}
            style={{
              flex: 1,
              padding: "4px",
              fontSize: "0.7rem",
